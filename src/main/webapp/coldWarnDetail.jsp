		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 警报详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form action="" >
					<table class="table table-hover">
							...
							<th>警报编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.warncode}" readonly="readonly" >
							...
							<th>警报名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.warnname}" readonly="readonly" >
							...
							<th>点位类型</th>
							<td>
					 			<c:if test="${oneColdWarn.warntype==1}">
						 			<input type="text" style="border: none;" value="温度 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdWarn.warntype==2}">
						 			<input type="text" style="border: none;" value="湿度 " readonly="readonly">
								</c:if>
								<c:if test="${oneColdWarn.warntype==3}">
						 			<input type="text" style="border: none;" value="火灾 " readonly="readonly">
								</c:if>
								<c:if test="${oneColdWarn.warntype==4}">
						 			<input type="text" style="border: none;" value="烟雾" readonly="readonly">
								</c:if>
							</td>
							</tr>
                            <tr>
							<th>警报阀值</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.threshold}" readonly="readonly" >
							...
							<th>点位类型</th>
							<td>
					 			<c:if test="${oneColdWarn.notifytype==1}">
						 			<input type="text" style="border: none;" value="短信 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdWarn.notifytype==2}">
						 			<input type="text" style="border: none;" value="邮件 " readonly="readonly">
								</c:if>
								<c:if test="${oneColdWarn.notifytype==3}">
						 			<input type="text" style="border: none;" value="站内消息 " readonly="readonly">
								</c:if>
							</td>
							</tr>
                            <tr>
							<th>通知频率</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.notifyinterval}" readonly="readonly" >
							...
							<th>通知地址</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.notifyaddr}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" value="<fmt:formatDate value="${oneColdWarn.createdt}" pattern="yyyy-MM-dd"/>" style="border: none;"readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdWarn.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" value="<fmt:formatDate value="${oneColdWarn.modifydt}" pattern="yyyy-MM-dd"/>" style="border: none;" readonly="readonly" >
