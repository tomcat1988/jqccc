		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>coldinterface/update/coldinterface" >
					<table class="table table-hover">
						
                            <tr>
							<th>接口编号</th>
							<td>
								<input type="hidden"  name="coldInterface.rowid" value="${oneColdInterface.rowid}"/>
					 			<input type="text" style="border: none;" name="coldInterface.infcode" value="${oneColdInterface.infcode}" >
							...
							<th>接口名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.infname" value="${oneColdInterface.infname}" >
							...
							<th>接口类型</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.inftype" value="${oneColdInterface.inftype}" >
						...
						<tr>
							<th>接口状态</th>
							<td>
								<select class="col-sm-3" name="coldInterface.status" id="power">
							...
							<th>接口参数</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.param"  value="${oneColdInterface.param}">
							...
							<th>接口url</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.url" value="${oneColdInterface.url}" >
						...
						<tr>
							<th>接口调用方式</th>
							<td>
								<select class="col-sm-3" name="coldInterface.infmethod" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">主动调用</option>
									<option class="form-control" value="2">被动接收</option>
								</select>
							</td>
						</tr>
                            <tr>
							<th>接口调用频率</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.infinterval" value="${oneColdInterface.infinterval}" >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.remark" value="${oneColdInterface.remark}" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.creator" value="管理员" readonly="readonly">
							</td>
						</tr>
                            <tr>
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneColdInterface.createdt }" pattern="yyyy-MM-dd"/>"  >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.modifyby" value="管理员" readonly="readonly" >
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/coldinterface/getAll/coldinterface/1";
	}
