		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 冷链仓详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form action="" >
					<table class="table table-hover">
							...
							<th>仓库代码</th>
							<td>
					 			<input type="text" style="border: none;" value="${ oneColdHub.hubcode}" readonly="readonly" >
							...
							<th>仓库名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.hubname}" readonly="readonly" >
							...
							<th>仓库状态</th>
							<td>
					 			<c:if test="${oneColdHub.status==1}">
						 			<input type="text" style="border: none;" value="正常 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdHub.status==2}">
						 			<input type="text" style="border: none;" value="停用 " readonly="readonly">
								</c:if>
								<c:if test="${oneColdHub.status==3}">
						 			<input type="text" style="border: none;" value="检修" readonly="readonly">
								</c:if>
							</td>
							</tr>
                            <tr>
							<th>最低温度</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.mintemp}" readonly="readonly" >
							...
							<th>最高温度</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.maxtemp}" readonly="readonly" >
							...
							<th>最低湿度</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.minhum}" readonly="readonly" >
							...
							<th>最高湿度</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.maxhum}" readonly="readonly" >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneColdHub.createdt}" pattern="yyyy-MM-dd"/>" readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdHub.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneColdHub.modifydt}" pattern="yyyy-MM-dd"/>" readonly="readonly" >
							</td>
						    </tr>
