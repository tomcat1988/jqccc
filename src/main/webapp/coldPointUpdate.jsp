		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>coldpoint/update/coldpoint" >
					<table class="table table-hover">
                            <tr>
							<th>点位编号</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.pointcode" value="${oneColdPoint.pointcode}" >
                                <input type="hidden"  name="coldPoint.rowid" value="${oneColdPoint.rowid}"/>
							</td>
						</tr>
                            <tr>
							<th>点位名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.pointname" value="${oneColdPoint.pointname}"  >
						...
						<tr>
							<th>点位类型</th>
							<td>
								<select class="col-sm-3" name="coldPoint.pointtype" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">温度监控</option>
									<option class="form-control" value="2">湿度监控</option>
									<option class="form-control" value="3">火灾监控</option>
									<option class="form-control" value="4">烟雾监控</option>
								</select>
							</td>
						</tr>
						<tr>
							<th>点位状态</th>
							<td>
								<select class="col-sm-3" name="coldPoint.status" id="power">
									<option class="form-control" value="0">--请选择--</option>
							...
							<th>安装仓库</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.hubcode" value="${oneColdPoint.hubcode}" >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.remark" value="${oneColdPoint.remark}" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.creator" value="管理员" readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.modifyby" value="管理员" readonly="readonly" >
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/coldpoint/getAll/coldpoint/1";
	}
