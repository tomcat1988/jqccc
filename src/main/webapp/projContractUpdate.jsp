		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 合同详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>projcontract/update/projcontract" >
					<table class="table table-hover">
						
                            <tr>
							<th>合同编号</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.contractcode" value="${oneProjContract.contractcode }"  >
                                <input type="hidden"  name="projContract.rowid" value="${oneProjContract.rowid}"/>
							</td>
						</tr>
                            <tr>
							<th>合同名称</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.contractname" value="${oneProjContract.contractname }"  >
							...
							<th>合同类型</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.contracttype"  value="${oneProjContract.contracttype }"  >
							...
							<th>合同状态</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.status"  value="${oneProjContract.status }"  >
							...
							<th>合同客户</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.customer"  value="${oneProjContract.customer }"  >
							...
							<th>开始时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneProjContract.startdt }" pattern="yyyy-MM-dd"/>"   >
							...
							<th>结束时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneProjContract.enddt}" pattern="yyyy-MM-dd"/>"   >
							...
							<th>合同附件</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.url"  value="${oneProjContract.url }" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.creator"  value="管理员" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"value="<fmt:formatDate value="${oneProjContract.createdt}" pattern="yyyy-MM-dd"/>"  >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.modifyby" value="管理员"  >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneProjContract.modifydt}" pattern="yyyy-MM-dd"/>"   >
							</td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/projcontract/getAll/projcontract/1";
	}
