		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 砝码租赁详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>pltlease/update/pltlease" >
					<table class="table table-hover">
						
                            <tr>
							<th>栈板名称</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.pltname" value="${ onePltLease.pltname}" >
                                <input type="hidden"  name="pltLease.rowid" value="${onePltLease.rowid}"/>
							</td>
						</tr>
                            <tr>
							<th>栈板类型</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.plttype"  value="${ onePltLease.plttype}">
							...
							<th>租赁数量</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.qty"  value="${ onePltLease.qty}" >
							...
							<th>租赁人</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.customer" value="${ onePltLease.customer}"  >
							...
							<th>租赁时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${onePltLease.leasedt}" pattern="yyyy-MM-dd"/>"    >
							...
							<th>预计归还时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly"   value="<fmt:formatDate value="${onePltLease.edt}" pattern="yyyy-MM-dd"/>"     >
							...
							<th>实际归还时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly"   value="<fmt:formatDate value="${ onePltLease.adt}" pattern="yyyy-MM-dd"/>"  >
							...
							<th>实际归还数量</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.backqty" value="${ onePltLease.backqty}" >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.remark"  value="${ onePltLease.remark}">
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.creator" value="管理员" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${onePltLease.createdt}" pattern="yyyy-MM-dd"/>" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.modifyby"  value="管理员">
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${onePltLease.modifydt}" pattern="yyyy-MM-dd"/>">
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/pltlease/getAll/pltlease/1";
	}
