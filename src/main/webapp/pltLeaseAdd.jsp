		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/pltlease/add/pltlease" >
					<table class="table table-hover">
                            <tr>
							<th>栈板名称</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.pltname"  >
							...
							<th>栈板类型</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.plttype"  >
							...
							<th>租赁数量</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.qty"  >
							...
							<th>租赁人</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.customer"  >
							...
							<th>实际归还数量</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.backqty"  >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="pltLease.remark"  >
