		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/coldhub/add/coldhub" >
					<table class="table table-hover">
                            <tr>
							<th>仓库代码</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.hubcode"  >
							...
							<th>仓库名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.hubname"  >
							...
							<th>仓库状态</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.status"  >
							...
							<th>最低温度</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.mintemp"  >
							...
							<th>最高温度</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.maxtemp"  >
							...
							<th>最低湿度</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.minhum"  >
							...
							<th>最高湿度</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.maxhum"  >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.remark"  >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.creator" value="管理员" readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldHub.modifyby"  value="管理员"  readonly="readonly">
