		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/basedevice/add/basedevice" >
					<table class="table table-hover">
                            <tr>
							<th>设备编号</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.devicecode"  >
							...
							<th>设备名称</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.devicename"  >
							...
							<th>设备类型</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.devicetype"  >
							...
							<th>规格型号</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.standard"  >
                        ...
                        <tr>
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.creator"  value="管理员" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.modifyby" value="管理员"  >
