		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/coldinterface/add/coldinterface" >
					<table class="table table-hover">
                            <tr>
							<th>接口编号</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.infcode"  >
							...
							<th>接口名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.infname"  >
							...
							<th>接口类型</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.inftype"  >
						...
						<tr>
							...
							<th>接口参数</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.param"  >
							...
							<th>接口url</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.url"  >
						...
						<tr>
							...
							<th>接口调用频率</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.infinterval "  >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" name="coldInterface.remark"  >
