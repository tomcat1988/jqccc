		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>设备详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>basedevice/update/basedevice" >
					<table class="table table-hover">
						
                            <tr>
							<th>设备编号</th>
							<td>
								<input type="hidden"  name="baseDevice.rowid" value="${oneBaseDevice.rowid}"/>
					 			<input type="text" style="border: none;" name="baseDevice.devicecode" value="${oneBaseDevice.devicecode }"  >
							...
							<th>设备名称</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.devicename"  value="${oneBaseDevice.devicename }" >
							...
							<th>设备类型</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.devicetype" value="${oneBaseDevice.devicetype }" >
							...
							<th>规格型号</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.standard" value="${oneBaseDevice.standard }" >
                        ...
                        <tr>
							...
							<td>
								...
								<select class="col-sm-3" name="baseDevice.status" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">使用中</option>
									<option class="form-control" value="2">检修中</option>
									<option class="form-control" value="3">已关闭</option>
								</select>
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly" value="管理员"  name="baseDevice.creator"  readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly" value="<fmt:formatDate value="${oneBaseDevice.createdt }" pattern="yyyy-MM-dd"/>"  >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="baseDevice.modifyby"  value="管理员" readonly="readonly" value="${oneBaseDevice.modifyby }"  >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  value="<fmt:formatDate value="${oneBaseDevice.modifydt }" pattern="yyyy-MM-dd"/>"   >
							</td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/basedevice/getAll/basedevice/1";
	}
