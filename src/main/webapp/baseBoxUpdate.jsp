		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 岗亭详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>basebox/update/basebox" >
					<table class="table table-hover">
						
						<tr>
							<th>岗亭编号</th>
							<td>
								<input type="hidden"  name="baseBox.rowid" value="${oneBaseBox.rowid}"/>
					 			<input type="text" style="border: none;" name="baseBox.boxcode" value="${oneBaseBox.boxcode }" >
							</td>
						</tr>
						<tr>
							<th>岗亭名称</th>
							<td>
								<input type="text" style="border: none;" name="baseBox.boxname" value="${oneBaseBox.boxname}" >
							</td>
						</tr>
						<tr>
							<th>岗亭类型</th>
							<td>
								<select class="col-sm-3" name="baseBox.boxtype" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">称重岗亭</option>
									<option class="form-control" value="2">收费岗亭</option>
									<option class="form-control" value="3">其他岗亭</option>
								</select>
							</td>
						</tr>
						<tr>
							<th>岗亭状态</th>
							<td>
								<select class="col-sm-3" name="baseBox.status" id="power">
									<option class="form-control" value="0">--请选择--</option>
						...
						<tr>
							<th>创建人</th>
							<td><input type="text" style="border: none;" readonly="readonly" name="baseBox.creator" value="${oneBaseBox.creator }" ></td>
						</tr>
						<tr>
							<th>创建时间</th>
					 		<td>
					 			<input type="text"  style="border: none;" readonly="readonly" value="<fmt:formatDate value="${oneBaseBox.createdt }" pattern="yyyy-MM-dd"/>"/>
					 		</td>
						</tr>
						<tr>
							<th>修改人</th>
					 		<td>
					 			<input type="text"  name="baseBox.modifyby" style="border: none;" value="管理员" readonly="readonly" value="${oneBaseBox.modifyby }" >
					 		</td>
						</tr>
						<tr>
							<th>修改时间</th>
					 		<td>
					 			<input type="text"   style="border: none;" readonly="readonly" value="<fmt:formatDate value="${oneBaseBox.modifydt }" pattern="yyyy-MM-dd"/>"/>
					 		</td>
						</tr>
						<tr>
							<td>
