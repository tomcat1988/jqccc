			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<table class="table table-hover">
							...
							<th>栈板名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${ onePltLease.pltname}" readonly="readonly" >
							...
							<th>栈板类型</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.plttype}" readonly="readonly" >
							...
							<th>租赁数量</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.qty}" readonly="readonly" >
							...
							<th>租赁人</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.customer}" readonly="readonly" >
							...
							<th>租赁时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltLease.leasedt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>预计归还时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltLease.edt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>实际归还时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltLease.adt}" pattern="yyyy-MM-dd"/>" readonly="readonly" >
							...
							<th>实际归还数量</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.backqty}" readonly="readonly" >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltLease.createdt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltLease.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltLease.modifydt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							</td>
						    </tr>
