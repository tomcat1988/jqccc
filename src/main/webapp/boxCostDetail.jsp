			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<table class="table table-hover">
							...
							<th>岗亭编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${ oneBoxCost.boxcode}" readonly="readonly" >
							...
							<th>岗亭名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxCost.boxname}" readonly="readonly" >
							...
							<th>收费时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneBoxCost.costtime }" pattern="yyyy-MM-dd"/>" readonly="readonly" >
							...
							<th>收费费用</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxCost.cost}" readonly="readonly" >
							...
							<th>车牌号码</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxCost.truckno}" readonly="readonly" >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxCost.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxCost.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneBoxCost.createdt }" pattern="yyyy-MM-dd"/>"readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxCost.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  value="<fmt:formatDate value="${oneBoxCost.modifydt }" pattern="yyyy-MM-dd"/>"readonly="readonly" >
							</td>
						    </tr>
					</table>
					</form>
