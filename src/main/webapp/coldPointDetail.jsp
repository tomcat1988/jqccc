		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>点位详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form action="" >
					<table class="table table-hover">
							...
							<th>点位编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${ oneColdPoint.pointcode}" readonly="readonly" >
							...
							<th>点位名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdPoint.pointname}" readonly="readonly" >
							...
							<th>点位类型</th>
							<td>
					 			<c:if test="${oneColdPoint.pointtype==1}">
						 			<input type="text" style="border: none;" value="温度监控 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdPoint.pointtype==2}">
						 			<input type="text" style="border: none;" value="湿度监控 " readonly="readonly">
								</c:if>
								<c:if test="${oneColdPoint.pointtype==3}">
						 			<input type="text" style="border: none;" value="火灾监控 " readonly="readonly">
								</c:if>
								<c:if test="${oneColdPoint.pointtype==4}">
						 			<input type="text" style="border: none;" value="烟雾监控 " readonly="readonly">
								</c:if>
							</td>
							</tr>
						    <tr>
							<th>点位状态</th>
							<td>
					 			<c:if test="${oneColdPoint.status==1}">
						 			<input type="text" style="border: none;" value="正常 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdPoint.status==2}">
							...
							<th>安装仓库</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdPoint.hubcode}" readonly="readonly" >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdPoint.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdPoint.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly" value="<fmt:formatDate value="${oneColdPoint.createdt}" pattern="yyyy-MM-dd"/>" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdPoint.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly" value="<fmt:formatDate value="${oneColdPoint.modifydt}" pattern="yyyy-MM-dd"/>">
							</td>
						    </tr>
