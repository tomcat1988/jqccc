			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<table class="table table-hover">
							...
							<th>设备编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseDevice.devicecode}" readonly="readonly" >
							...
							<th>设备名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseDevice.devicename}" readonly="readonly" >
							...
							<th>设备类型</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseDevice.devicetype}" readonly="readonly" >
							...
							<th>规格型号</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseDevice.standard}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseDevice.creator}" readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseDevice.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly" value="<fmt:formatDate value="${oneBaseDevice.modifydt }" pattern="yyyy-MM-dd"/>"/>
							</td>
						    </tr>
