		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>称重详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>/boxgw/add/boxgw" >
					<table class="table table-hover">
                            <tr>
							<th>岗亭编号</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.boxcode"  >
							...
							<th>岗亭名称</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.boxname"  >
							...
							<th>称重重量</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.gw"  >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.remark"  >
