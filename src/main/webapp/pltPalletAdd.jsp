		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/pltpallet/add/pltpallet" >
					<table class="table table-hover">
                            <tr>
							<th>栈板名称</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.pltname"  >
							...
							<th>栈板类型</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.plttype"  >
							...
							<th>数量</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.qty"  >
						...
						<tr>
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.remark"  >
