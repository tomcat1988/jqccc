		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>岗亭称重详细信息<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>boxgw/update/boxgw" >
					<table class="table table-hover">
						
                            <tr>
							<th>岗亭编号</th>
							<td>
								<input type="hidden"  name="boxGw.rowid" value="${oneBoxGw.rowid}"/>
					 			<input type="text" style="border: none;" name="boxGw.boxcode"  value="${oneBoxGw.boxcode}">
							</td>
						</tr>
                            <tr>
							<th>岗亭名称</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.boxname"  value="${oneBoxGw.boxname}">
							...
							<th>称重时间</th>
							<td>
					 			<input type="text" style="border: none;"   readonly="readonly"   value="<fmt:formatDate value="${oneBoxGw.gwtime }" pattern="yyyy-MM-dd"/>" >
							...
							<th>称重重量</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.gw" value="${oneBoxGw.gw}"  >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.remark" value="${oneBoxGw.remark}" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.creator" value="管理员" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneBoxGw.createdt }" pattern="yyyy-MM-dd"/>"  >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="boxGw.modifyby" value="管理员" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneBoxGw.modifydt}" pattern="yyyy-MM-dd"/>"  >
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/boxgw/getAll/boxgw/1";
	}
