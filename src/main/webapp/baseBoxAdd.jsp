		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/basebox/add/basebox" >
					<table class="table table-hover">
						
						<tr>
							<th>岗亭编号</th>
							<td>
					 			<input type="text" style="border: none;" name="baseBox.boxcode"  >
							</td>
						</tr>
						<tr>
							<th>岗亭名称</th>
							<td>
								<input type="text" style="border: none;" name="baseBox.boxname"  >
							</td>
						</tr>
						<tr>
							<th>岗亭类型</th>
						...
						<tr>
							<th>创建人</th>
							<td><input type="text" style="border: none;" readonly="readonly" name="baseBox.creator" ></td>
						</tr>
						<tr>
							<th>创建时间</th>
					 		<td>
						...
						<tr>
							<th>修改人</th>
					 		<td>
					 			<input type="text"  name="baseBox.modifyby" style="border: none;" value="管理员" readonly="readonly"  >
					 		</td>
						</tr>
						<tr>
							<th>修改时间</th>
