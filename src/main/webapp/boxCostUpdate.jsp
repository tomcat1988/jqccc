		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 岗亭收费详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>boxcost/update/boxcost" >
					<table class="table table-hover">
						
                            <tr>
							<th>岗亭编号</th>
							<td>
								<input type="hidden"  name="boxCost.rowid" value="${oneBoxCost.rowid}"/>
					 			<input type="text" style="border: none;" name="boxCost.boxcode"  value="${oneBoxCost.boxcode}" >
							...
							<th>岗亭名称</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.boxname" value="${oneBoxCost.boxname}"  >
							...
							<th>收费时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly"   value="<fmt:formatDate value="${oneBoxCost.costtime }" pattern="yyyy-MM-dd"/>"  > 
							...
							<th>收费费用</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.cost"   value="${oneBoxCost.cost}" >
							</td>
						</tr>
                            <tr>
							<th>车牌号码</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.truckno" value="${oneBoxCost.truckno}" >
							</td>
						</tr>
                            <tr>
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.remark" value="${oneBoxCost.remark}" >
							</td>
						</tr>
                            <tr>
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.creator"  value="管理员" readonly="readonly"  >
							</td>
						</tr>
                            <tr>
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"  value="<fmt:formatDate value="${oneBoxCost.createdt }" pattern="yyyy-MM-dd"/>"  >
							</td>
						</tr>
                            <tr>
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.modifyby" value="管理员" readonly="readonly"   >
							</td>
						</tr>
                            <tr>
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly"  value="<fmt:formatDate value="${oneBoxCost.modifydt }" pattern="yyyy-MM-dd"/>"  >
							</td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/boxcost/getAll/boxcost/1";
	}
