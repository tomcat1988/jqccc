		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 砝码详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>pltpallet/update/pltpallet" >
					<table class="table table-hover">
						
                            <tr>
							<th>栈板名称</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.pltname" value="${onePltPallet.pltname}"  >
                                <input type="hidden"  name="pltPallet.rowid" value="${onePltPallet.rowid}"/>
							</td>
						</tr>
                            <tr>
							<th>栈板类型</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.plttype" value="${onePltPallet.plttype}"  >
							...
							<th>数量</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.qty"  value="${onePltPallet.qty}" >
						...
						<tr>
							<th>栈板状态</th>
							<td>
								<select class="col-sm-3" name="pltPallet.status" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">报废</option>
									<option class="form-control" value="2">正常</option>
									<option class="form-control" value="3">检修</option>
									<option class="form-control" value="4">破损</option>
								</select>
							</td>
						</tr>
                            <tr>
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.remark"  value="${onePltPallet.remark}" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.creator"  value="管理员">
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="pltPallet.modifyby" value="管理员" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltPallet.modifydt}" pattern="yyyy-MM-dd"/>"  >
							</td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/pltpallet/getAll/pltpallet/1";
	}
