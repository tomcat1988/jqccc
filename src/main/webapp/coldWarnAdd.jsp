		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/coldwarn/add/coldwarn" >
					<table class="table table-hover">
                            <tr>
							<th>警报编号</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.warncode"  >
							...
							<th>警报名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.warnname"  >
						...
						<tr>
							...
							<th>警报阀值</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.threshold"  >
						...
						<tr>
							...
							<td>
								<select class="col-sm-3" name="coldWarn.notifytype" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">短信</option>
									<option class="form-control" value="2">邮件</option>
									<option class="form-control" value="3">站内消息</option>
								</select>
							</td>
						</tr>
                            <tr>
							<th>通知频率</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.notifyinterval"  >
							...
							<th>通知地址</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.notifyaddr"  >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.creator" value="管理员"  >
