		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>接口详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form action="" >
					<table class="table table-hover">
							...
							<th>接口编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${ oneColdInterface.infcode}" readonly="readonly" >
							...
							<th>接口名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.infname}" readonly="readonly" >
							...
							<th>接口类型</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.inftype}" readonly="readonly" >
							...
							<th>接口状态</th>
							<td>
					 			<c:if test="${oneColdInterface.status==1}">
						 			<input type="text" style="border: none;" value="正常 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdInterface.status==2}">
						 			<input type="text" style="border: none;" value="停用 " readonly="readonly">
								</c:if>
							</td>
							</tr>
                            <tr>
							<th>接口参数</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.param}" readonly="readonly" >
							...
							<th>接口url</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.url}" readonly="readonly" >
							...
							<th>接口调用方式</th>
							<td>
					 			<c:if test="${oneColdInterface.infmethod==1}">
						 			<input type="text" style="border: none;" value="主动调用 " readonly="readonly">
								</c:if>
					 			<c:if test="${oneColdInterface.infmethod==2}">
						 			<input type="text" style="border: none;" value="被动接收" readonly="readonly">
								</c:if>
							</td>
							</tr>
                            <tr>
							<th>接口调用频率</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.infinterval}" readonly="readonly" >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"value="<fmt:formatDate value="${oneColdInterface.createdt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneColdInterface.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"value="<fmt:formatDate value="${oneColdInterface.modifydt}" pattern="yyyy-MM-dd"/>" readonly="readonly" >
