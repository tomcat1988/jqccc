		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 码盘详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form action="" >
					<table class="table table-hover">
							...
							<th>栈板名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltPallet.pltname}" readonly="readonly" >
							...
							<th>栈板类型</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltPallet.plttype}" readonly="readonly" >
							...
							<th>数量</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltPallet.qty}" readonly="readonly" >
							...
							<th>栈板状态</th>
							<td>
					 			<c:if test="${onePltPallet.status==1}">
						 			<input type="text" style="border: none;" value="报废 " readonly="readonly">
								</c:if>
					 			<c:if test="${onePltPallet.status==2}">
						 			<input type="text" style="border: none;" value="正常 " readonly="readonly">
								</c:if>
								<c:if test="${onePltPallet.status==3}">
						 			<input type="text" style="border: none;" value="检修 " readonly="readonly">
								</c:if>
								<c:if test="${onePltPallet.status==4}">
						 			<input type="text" style="border: none;" value="破损" readonly="readonly">
								</c:if>
							</td>
							</tr>
                            <tr>
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltPallet.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltPallet.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltPallet.createdt}" pattern="yyyy-MM-dd"/>" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${onePltPallet.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${onePltPallet.modifydt}" pattern="yyyy-MM-dd"/>" readonly="readonly" >
