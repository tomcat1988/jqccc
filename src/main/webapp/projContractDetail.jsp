			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<table class="table table-hover">
							...
							<th>合同编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.contractcode }" readonly="readonly" >
							...
							<th>合同名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.contractname }" readonly="readonly" >
							...
							<th>合同类型</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.contracttype }" readonly="readonly" >
							...
							<th>合同状态</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.status }" readonly="readonly" >
							...
							<th>合同客户</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.customer }" readonly="readonly" >
							...
							<th>开始时间</th>
							<td>
					 			<input type="text" style="border: none;"value="<fmt:formatDate value="${oneProjContract.startdt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>结束时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneProjContract.enddt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>合同附件</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.url }" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.creator }" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneProjContract.createdt}" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneProjContract.modifyby }" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneProjContract.modifydt}" pattern="yyyy-MM-dd"/>" readonly="readonly" >
