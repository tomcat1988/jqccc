		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/projcontract/add/projcontract" >
					<table class="table table-hover">
                            <tr>
							<th>合同编号</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.contractcode"  >
							...
							<th>合同名称</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.contractname"  >
							...
							<th>合同类型</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.contracttype"  >
							...
							<th>合同状态</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.status"  >
							...
							<th>合同客户</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.customer"  >
							...
							<th>合同附件</th>
							<td>
					 			<input type="text" style="border: none;" name="projContract.url"  >
