		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>cargoorder/update/cargoorder" >
					<table class="table table-hover">
						
                            <tr>
							<th>订单</th>
							<td>
								<input type="hidden"  name="cargoOrder.rowid" value="${oneCargoOrder.rowid}"/>
					 			<input type="text" style="border: none;" name="cargoOrder.orderno"   value="${oneCargoOrder.orderno}" >
							...
							<th>起运地</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.origin"  value="${oneCargoOrder.origin}" >
							...
							<th>目的地</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.destination"  value="${oneCargoOrder.destination}" >
							...
							<th>客户/货主</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.customer"  value="${oneCargoOrder.customer}">
							...
							<th>联系电话</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.tel"  value="${oneCargoOrder.tel}">
							...
							<th>要求发货时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneCargoOrder.startdt }" pattern="yyyy-MM-dd"/>"  >
							...
							<th>要求到货时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneCargoOrder.enddt }" pattern="yyyy-MM-dd"/>">
							...
							<th>重量</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.gw" value="${oneCargoOrder.gw}" >
							...
							<th>体积</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.cbm"  value="${oneCargoOrder.cbm}">
						...
						<tr>
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" name="cargoOrder.remark"  value="${oneCargoOrder.orderno}">
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneCargoOrder.createdt }" pattern="yyyy-MM-dd"/>">
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneCargoOrder.modifydt}" pattern="yyyy-MM-dd"/>">
							</td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/cargoorder/getAll/cargoorder/1";
	}
