		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>收费详情<a  class="fa fa-angle-right" href="javascript:history.go(-1)">返回</a>
					</h4>
					<hr>
					<form  method="post" action="<%=basePath%>/boxcost/add/boxcost" >
					<table class="table table-hover">
                            <tr>
							<th>岗亭编号</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.boxcode"  >
							...
							<th>岗亭名称</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.boxname"  >
							...
							<th>收费费用</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.cost"  >
							...
							<th>车牌号码</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.truckno"  >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.remark"  >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.creator" value="管理员"  >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="boxCost.modifyby"  value="管理员"  >
