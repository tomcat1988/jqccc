		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>/coldpoint/add/coldpoint" >
					<table class="table table-hover">
                            <tr>
							<th>点位编号</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.pointcode"  >
							...
							<th>点位名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.pointname"  >
						...
						<tr>
							...
							<th>安装仓库</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.hubcode"  >
							...
							<th>备注</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.remark"  >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.creator" value="管理员"  >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldPoint.modifyby" value="管理员"  >
