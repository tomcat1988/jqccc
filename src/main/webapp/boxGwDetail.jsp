			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<table class="table table-hover">
							...
							<th>岗亭编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${ oneBoxGw.boxcode}" readonly="readonly" >
							...
							<th>岗亭名称</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxGw.boxname}" readonly="readonly" >
							...
							<th>称重时间</th>
							<td>
					 			<input type="text" style="border: none;"  value="<fmt:formatDate value="${oneBoxGw.gwtime }" pattern="yyyy-MM-dd"/>" readonly="readonly" >
							...
							<th>称重重量</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxGw.gw}" readonly="readonly" >
							...
							<th>备注说明</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxGw.remark}" readonly="readonly" >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxGw.creator}" readonly="readonly" >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;"  value="<fmt:formatDate value="${oneBoxGw.createdt }" pattern="yyyy-MM-dd"/>"  readonly="readonly" >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBoxGw.modifyby}" readonly="readonly" >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;" value="<fmt:formatDate value="${oneBoxGw.modifydt }" pattern="yyyy-MM-dd"/>" readonly="readonly" >
