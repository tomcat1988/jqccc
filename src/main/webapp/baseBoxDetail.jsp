				...
				<div class="content-panel">
					...
					<table class="table table-hover">
						<tr>
							<th>岗亭编号</th>
							<td>
					 			<input type="text" style="border: none;" value="${oneBaseBox.boxcode }" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>岗亭名称</th>
							<td>
								<input type="text" style="border: none;" value="${oneBaseBox.boxname}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>岗亭类型</th>
							<td>
					 			<c:if test="${oneBaseBox.boxtype==1}">
						 			<input type="text" style="border: none;" value="称重岗亭" readonly="readonly">
								</c:if>
					 			<c:if test="${oneBaseBox.boxtype==2}">
						 			<input type="text" style="border: none;" value="收费岗亭" readonly="readonly">
								</c:if>
								<c:if test="${oneBaseBox.boxtype==3}">
						 			<input type="text" style="border: none;" value="其他岗亭 " readonly="readonly">
								</c:if>
							</td>
						</tr>
						<tr>
							<th>岗亭状态</th>
							<td>
								<c:if test="${oneBaseBox.status==1}">
						 			<input type="text" style="border: none;" value="使用中" readonly="readonly">
								</c:if>
					 			<c:if test="${oneBaseBox.status==2}">
						 			<input type="text" style="border: none;" value="检修中" readonly="readonly">
								</c:if>
								<c:if test="${oneBaseBox.status==3}">
						 			<input type="text" style="border: none;" value="已关闭" readonly="readonly">
								</c:if>
							</td>
						</tr>
						<tr>
							<th>创建人</th>
							<td><input type="text" style="border: none;" value="管理员" readonly="readonly"></td>
						</tr>
						<tr>
							<th>创建时间</th>
					 		<td>
						...
						<tr>
							<th>修改人</th>
					 		<td>
					 			<input type="text" style="border: none;" value="管理员" readonly="readonly">
					 		</td>
						</tr>
						<tr>
							<th>修改时间</th>
