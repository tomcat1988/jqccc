		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					...
					<hr>
					<form  method="post" action="<%=basePath%>coldwarn/update/coldwarn" >
					<table class="table table-hover">
						
                            <tr>
							<th>警报编号</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.warncode"  value="${oneColdWarn.warncode}" >
                                <input type="hidden"  name="coldWarn.rowid" value="${oneColdWarn.rowid}"/>
							</td>
						</tr>
                            <tr>
							<th>警报名称</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.warnname" value="${oneColdWarn.warnname}"   >
						...
						<tr>
							<th>警报类型</th>
							<td>
								<select class="col-sm-3" name="coldWarn.warntype" id="power">
									<option class="form-control" value="0">--请选择--</option>
									<option class="form-control" value="1">温度</option>
									<option class="form-control" value="2">湿度</option>
									<option class="form-control" value="3">火灾</option>
									<option class="form-control" value="4">烟雾</option>
								</select>
							</td>
						</tr>
                            <tr>
							<th>警报阀值</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.threshold"  value="${oneColdWarn.threshold}" >
						...
						<tr>
							<th>通知方式</th>
							<td>
								<select class="col-sm-3" name="coldWarn.notifytype" id="power">
									<option class="form-control" value="0">--请选择--</option>
							...
							<th>通知频率</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.notifyinterval" value="${oneColdWarn.notifyinterval}"  >
							...
							<th>通知地址</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.notifyaddr" value="${oneColdWarn.notifyaddr}"  >
							...
							<th>创建人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.creator" value="管理员"  readonly="readonly"  >
							...
							<th>创建时间</th>
							<td>
					 			<input type="text" style="border: none;" readonly="readonly"   value="<fmt:formatDate value="${oneColdWarn.createdt}" pattern="yyyy-MM-dd"/>"   >
							...
							<th>修改人</th>
							<td>
					 			<input type="text" style="border: none;" name="coldWarn.modifyby" value="管理员"  >
							...
							<th>修改时间</th>
							<td>
					 			<input type="text" style="border: none;"  readonly="readonly"   value="<fmt:formatDate value="${oneColdWarn.modifydt}" pattern="yyyy-MM-dd"/>"   >
...
<script type="text/javascript">
	...
	{
		window.location.href="<%=basePath%>/coldwarn/getAll/coldwarn/1";
	}
