		...
		<div class="content-panel">
			<form action="<%=basePath%>limit/upd.do" method="post" name="frm">
				...
				&nbsp;&nbsp;<input class="btn btn-primary" type="button"
					...
					value="1" name="inp" id="inp" <% if (true) {%>       <-- (lists.contains("1")  -->
					checked="checked" <%}%>> 部门管理
				&nbsp;&nbsp; <input type="checkbox"
					value="2" name="inp" id="inp" <% if (false) {%>
					checked="checked" <%}%>> 员工管理
				&nbsp;&nbsp;
				<input type="checkbox"
					value="3" name="inp" id="inp" <%if (false) {%>
				...
				&nbsp;&nbsp;<input type="button"
					...
					&nbsp;&nbsp; <input type="checkbox"
					value="4" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 提现管理
				&nbsp;&nbsp; <input type="checkbox"
					value="5" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 银行卡管理
				&nbsp;&nbsp; <input type="checkbox"
					value="6" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 充值记录
				&nbsp;&nbsp; <input type="checkbox"
					value="7" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 手续费记录
				&nbsp;&nbsp; <input type="checkbox"
					value="8" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 交易记录
				&nbsp;&nbsp; <input type="checkbox"
					value="9" name="inp" <%if (false) {%>
				...
				&nbsp;&nbsp;<input type="button"
					...
					type="checkbox" value="10" name="inp" <%if (false) {%>
				...
				&nbsp;&nbsp;<input type="button"
				 ...
				 &nbsp;&nbsp; <input type="checkbox"
					value="15" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 投标列表&nbsp;&nbsp;
				<input type="checkbox"
					value="16" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 添加投标&nbsp;&nbsp;
				<input type="checkbox"
					value="17" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 标种列表&nbsp;&nbsp;
				<input type="checkbox"
					value="18" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 添加标种
				&nbsp;&nbsp;<input type="checkbox"
					value="19" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 所有借款
				&nbsp;&nbsp;
				<input type="checkbox"
					value="20" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 待审核借款<br>
				&nbsp;&nbsp;
				<input type="checkbox"
					value="21" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 招标中的借款
				&nbsp;&nbsp;
				&nbsp;&nbsp;<input type="checkbox"
					value="22" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 还款
				&nbsp;&nbsp;<input type="checkbox"
					value="23" name="inp" <%if (false) {%>
					checked="checked" <%}%>> 满标借款
				&nbsp;&nbsp;
				<input type="checkbox"
					value="24" name="inp" <%if (false) {%>
