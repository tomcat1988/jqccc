		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i> 根据单号修改投标的信息
					</h4>
					<!-- 页面内容 -->
					<form id="frm1" class="form-horizontal tasi-form" action="<%=basePath%>rent/queryOneRentById" method="post">
					
						<button type="submit"  class="btn btn-theme03">查找</button>
						<div class="form-group">
							<label class="col-sm-2   control-label">贷款订单号</label>
							<div class="col-sm-5">
