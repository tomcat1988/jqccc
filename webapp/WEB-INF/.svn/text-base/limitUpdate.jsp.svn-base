		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<hr>
					<form action="<%=basePath%>emp/updateUserInfo" method="post" onsubmit="register()">
						<table class="table table-hover">
							...
							<tbody>
							<tr>
								<td><input type="text" name="emp.empid" readonly="readonly" value="${empInfo.empid }"/></td>
								<td><input type="text" id="empusername" name="emp.empusername" onblur="" value="${empInfo.empusername }"/>
									<span id="errorempusername"></span>
								</td>
								<td><input type="text" id="emppwd" name="emp.emppwd" value="${empInfo.emppwd }"/>
									<span id="erroremppwd"></span>
								</td>
								<td><input type="text" id="empname" name="emp.empname" value="${empInfo.empname }"/>
									<span id="errorempname"></span>
								</td>
								<td><input type="text" name="emp.power" readonly="readonly" value="${empInfo.power }"/></td>
								<td><input type="submit" value="修改" onclick="return confirm('确定要修改信息吗?')"/></td>
							</tr>
							</tbody>
							<tbody>
						</table>
