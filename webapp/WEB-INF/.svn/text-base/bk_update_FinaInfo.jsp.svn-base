		...
		<section class="wrapper">
			...
			<div class="col-md-12 mt">
				<div class="content-panel">
					<h4>
						<i class="fa fa-angle-right"></i>提交修改的信息
					</h4>
				<form action="<%=basePath%>fin/updateFina"  method="post">
					<table class="table table-hover">
								<tr>
									<th>用户名</th>
									<td>
										<input type="hidden" value="${fina.finid }" id="finid" name="financeinfo.finid"/>
										<input type="hidden" value="${fina.userid }" id="userid" name="userInfo.userid"/>
										<input type="hidden" value="${fina.proid }" id="proid" name="financeinfo.proid"/>
										<input type="text"  style="border: none" name="financeinfo.usernickname" value="${fina.usernickname }" readonly="readonly"/>
									</td>
								</tr>
								<tr>
									<th>身份证号</th>
									<td>
										<input type="text" style="border: none"  name="userInfo.useridcard"  value="${fina.useridcard }" id="useridcard" />
									</td>
								</tr>
								<tr>
									<th>性别</th>
									<td>
										<c:if test="${fina.usersex==1 }">
											<input name="financeinfo.usersex" style="border: none"  type="text" value="男">
										</c:if>
										<c:if test="${fina.usersex==0 }">
											<input name="financeinfo.usersex" style="border: none"  type="text" value="女">
										</c:if>
									</td>
								</tr>
								<tr>
									<th>出生日期</th>
									<td><input type="text" name="userInfo.userdate" style="border: none" readonly="readonly"   value="<fmt:formatDate value="${fina.userdate }" pattern="yyyy-MM-dd"/>"/></td>
								</tr>
								<tr>
									<th>银行卡号</th>
									<td><input type ="text" name="userInfo.usercard" style="border: none"  value="${fina.usercard }"/></td>
								</tr>
								<tr>
									<th>电话</th>
									<td><input type="text" style="border: none"  value="${fina.usertel }" name="userInfo.usertel"/></td>
								</tr>
								<tr>
									<th>邮箱</th>
									<td><input type="text" style="border: none"  value="${fina.usermail }" name="userInfo.usermail" /></td>
								</tr>
								<tr>
									<th>产品名称</th>
									<td><input type="text" style="border: none"  value="${fina.proname }" readonly="readonly" name="financeinfo.proname" /></td>
								</tr>
								<tr>
									<th>理财产品类型</th>
									<td><input type="text" style="border: none" name="financeinfo.protype" readonly="readonly"   value="${fina.protype }"/></td>
								</tr>
								<tr>
									<th>产品最低投标金额</th>
									<td><input type="text" style="border: none"  value="${fina.proprice }" readonly="readonly" name="financeinfo.proprice" /></td>
								</tr>
								<tr>
									<th>产品收益率</th>
									<td><input type="text" style="border: none"  value="${fina.proprofit }" readonly="readonly" name="financeinfo.proprofit" /></td>
								</tr>
								<tr>
									<td><input type="submit" style="border: none" value="提交"/></td>
								</tr>
						</table>
					</form>
				</div>
