		...
		<section class="wrapper">
			...
			<div class="col-ld-15">
				<div >
					...
					<div class="col-md-14">
					<form action="basicuserapprove.jsp" method="post"> 
						...
						<input type="hidden" name="cruserid" id="cruserid" value="450921199408082464"/>
						</form>
					</div><hr>
					<table class="table ">
						<tr align="center">
						...
						-->
							...
							<td>
								admin
								<input type="hidden" id="crauditor" name="crauditor" value=""/>
