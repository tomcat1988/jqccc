				...
				<div class="content-panel">
					...
					<table class="table table-hover">
								<tr>
									...
									<th>产品名称</th>
									<td>
										<input type="text" readonly="readonly" value="${prolist.proname }"/>
									</td>
								</tr>
								<tr>
									<th>产品类型</th>
									<td>
										<c:choose>
											<c:when test="${prolist.protype==1 }">
												<input type="text" readonly="readonly" value="小金金"/>
											</c:when>
											<c:when test="${prolist.protype==2 }">
								...
								<tr>
									<th>理财产品截至标期</th>
									<td>
									<fmt:formatDate value="${prolist.proenddate}"  pattern="yyyy-MM-dd"/>
									
									<%-- <input type="text" readonly="readonly" value="${prolist.proenddate }" /></td> --%>
								</tr>
								<tr>
									<th>企业名称</th>
								...
								<tr>
									<th>产品上线时间</th>
									<td><input type="text" readonly="readonly" value="${prolist.prodate }"/></td>
								</tr>
								<tr>
									<th>二审审核时间</th>
									<td>
									<fmt:formatDate value="${prolist.checkseconddate}"  pattern="yyyy-MM-dd"/>
									<%-- <input type="text" readonly="readonly" value="${prolist.checkseconddate }"/></td> --%>
								</tr>
								<tr>
									<th>二审审核人</th>
									<td><input type="text" readonly="readonly" value="${prolist.checksecondname }"/></td>
								</tr>
					</table>
