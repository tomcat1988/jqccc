          ...
          <section class="wrapper"> 
         		...
         		<div class="showback">
                          ...
                          <div class="form-group" align="justify">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  name="noticetitle" class="form-control" value="">
                                  <input type="hidden"  name="noticepicture" value="">
                              </div>
                         </div>
							 <div class="form-group" align="justify">
                              ...
                              <div class="col-sm-10">
                                <select class="form-control" name="noticetype">
									  <option value="1" ${'1'=='1'?'selected':'' }>网站公告</option>
                         ...
                         <div class="form-group" align="justify">
                              <label class="col-sm-2 col-sm-2 control-label">图片</label>
                              <div class="col-sm-10">
                                  <img alt="" src="" width="80xp" height="100xp">
                              </div>
                         </div>
