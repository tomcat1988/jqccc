				...
				<div class="content-panel">
					...
					<table class="table table-hover">
						...
						<tr>
							<th>身份证号</th>
							<td>
								<input type="text" id="useridcard" style="border: none;" value="${userInfo.useridcard}" readonly="readonly">
								<c:choose>
	...
	function checkId()
	{
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				{
					//查询信息准确
					$("#msg").html("该身份证号所属地区是:"+data.area+",性别:"+data.sex+",出生日期:"+data.birthday);
				}
				else
				{
					//查询错误的身份证信息
